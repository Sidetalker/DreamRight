...
public class DreamRightSK : NSObject {
    ...
    public class func drawPlayUp(frame: CGRect) {
        ...
        bezierPath.moveToPoint(CGPointMake(group.minX + 0.65625 * group.width, group.minY + 0.48958 * group.height))
        bezierPath.addLineToPoint(CGPointMake(group.minX + 0.36458 * group.width, group.minY + 0.34375 * group.height))
        bezierPath.addLineToPoint(CGPointMake(group.minX + 0.36458 * group.width, group.minY + 0.63542 * group.height))
        bezierPath.addLineToPoint(CGPointMake(group.minX + 0.65625 * group.width, group.minY + 0.48958 * group.height))
