...
public class DreamRightSK : NSObject {
    ...
    public class func drawLoneStar(frame: CGRect) {
        ...
        //// StarBig Drawing
        var starBigPath = UIBezierPath()
        starBigPath.moveToPoint(CGPointMake(frame.minX + 0.50958 * frame.width, frame.minY + 0.06539 * frame.height))
        starBigPath.addCurveToPoint(CGPointMake(frame.minX + 0.62483 * frame.width, frame.minY + 0.38278 * frame.height), controlPoint1: CGPointMake(frame.minX + 0.50958 * frame.width, frame.minY + 0.06539 * frame.height), controlPoint2: CGPointMake(frame.minX + 0.50958 * frame.width, frame.minY + 0.27699 * frame.height))
        starBigPath.addCurveToPoint(CGPointMake(frame.minX + 0.97059 * frame.width, frame.minY + 0.48858 * frame.height), controlPoint1: CGPointMake(frame.minX + 0.74008 * frame.width, frame.minY + 0.48858 * frame.height), controlPoint2: CGPointMake(frame.minX + 0.97059 * frame.width, frame.minY + 0.48858 * frame.height))
        starBigPath.addCurveToPoint(CGPointMake(frame.minX + 0.62483 * frame.width, frame.minY + 0.59438 * frame.height), controlPoint1: CGPointMake(frame.minX + 0.97059 * frame.width, frame.minY + 0.48858 * frame.height), controlPoint2: CGPointMake(frame.minX + 0.74008 * frame.width, frame.minY + 0.48858 * frame.height))
        starBigPath.addCurveToPoint(CGPointMake(frame.minX + 0.50958 * frame.width, frame.minY + 0.91176 * frame.height), controlPoint1: CGPointMake(frame.minX + 0.50958 * frame.width, frame.minY + 0.70017 * frame.height), controlPoint2: CGPointMake(frame.minX + 0.50958 * frame.width, frame.minY + 0.91176 * frame.height))
        starBigPath.addCurveToPoint(CGPointMake(frame.minX + 0.39432 * frame.width, frame.minY + 0.59438 * frame.height), controlPoint1: CGPointMake(frame.minX + 0.50958 * frame.width, frame.minY + 0.91176 * frame.height), controlPoint2: CGPointMake(frame.minX + 0.50958 * frame.width, frame.minY + 0.70017 * frame.height))
        starBigPath.addCurveToPoint(CGPointMake(frame.minX + 0.04856 * frame.width, frame.minY + 0.48858 * frame.height), controlPoint1: CGPointMake(frame.minX + 0.27907 * frame.width, frame.minY + 0.48858 * frame.height), controlPoint2: CGPointMake(frame.minX + 0.04856 * frame.width, frame.minY + 0.48858 * frame.height))
        starBigPath.addCurveToPoint(CGPointMake(frame.minX + 0.39432 * frame.width, frame.minY + 0.38278 * frame.height), controlPoint1: CGPointMake(frame.minX + 0.04856 * frame.width, frame.minY + 0.48858 * frame.height), controlPoint2: CGPointMake(frame.minX + 0.27907 * frame.width, frame.minY + 0.48858 * frame.height))
        starBigPath.addCurveToPoint(CGPointMake(frame.minX + 0.50958 * frame.width, frame.minY + 0.06539 * frame.height), controlPoint1: CGPointMake(frame.minX + 0.50958 * frame.width, frame.minY + 0.27699 * frame.height), controlPoint2: CGPointMake(frame.minX + 0.50958 * frame.width, frame.minY + 0.06539 * frame.height))
        starBigPath.closePath()
        starBigPath.lineCapStyle = kCGLineCapRound;
